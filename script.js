document.addEventListener("DOMContentLoaded", function () {
    ...
    var gistUrl = "https://api.github.com/gists/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"; // Replace with your Gist URL
    ...
    function updateGist(redeemedCodes) {
        ...
        var requestOptions = {
            method: 'PATCH',
            headers: {
                'Authorization': 'Bearer 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', // Replace with your actual GitHub personal access token
